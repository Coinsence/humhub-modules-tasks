...
?>
<div class="panel task-upcoming-snippet <?= $cssClass ?>" id="task-my-tasks-snippet">
<?php if (Yii::$app->user->id === $user->id) : ?>
    <div class="panel-heading panelHeadingCustom">
    <div class="panelHeadingCustomBlock">
               <span> <?= Yii::t('TasksModule.widgets_views_myTasks', 'Involved in following tasks'); ?></span>
